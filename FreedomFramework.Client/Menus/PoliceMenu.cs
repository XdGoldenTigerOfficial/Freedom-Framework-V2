    ...
    public class PoliceMenu : BaseScript
    {
        ...
        private void Outfits(UIMenu menu)
        {
            ...
            outfits.OnItemSelect += async (sender, item, index) =>
            {
                if (item == bcsom)
                {
                    await CitizenFX.Core.Game.Player.ChangeModel(PedHash.Sheriff01SMY);
                    CitizenFX.Core.Game.Player.Character.Style.RandomizeOutfit();
                    CitizenFX.Core.Game.Player.Character.Style.RandomizeProps();
                }
            };
            ...
            outfits.OnItemSelect += async (sender, item, index) =>
            {
                if (item == bcsof)
                {
                    await CitizenFX.Core.Game.Player.ChangeModel(PedHash.Sheriff01SFY);
                    CitizenFX.Core.Game.Player.Character.Style.RandomizeOutfit();
                    CitizenFX.Core.Game.Player.Character.Style.RandomizeProps();
                }
            };
            ...
            outfits.OnItemSelect += async (sender, item, index) =>
            {
                if (item == lspdm)
                {
                    await CitizenFX.Core.Game.Player.ChangeModel(PedHash.Cop01SMY);
                    CitizenFX.Core.Game.Player.Character.Style.RandomizeOutfit();
                    CitizenFX.Core.Game.Player.Character.Style.RandomizeProps();
                }
            };
            ...
            outfits.OnItemSelect += async (sender, item, index) =>
            {
                if (item == lspdf)
                {
                    await CitizenFX.Core.Game.Player.ChangeModel(PedHash.Cop01SFY);
                    CitizenFX.Core.Game.Player.Character.Style.RandomizeOutfit();
                    CitizenFX.Core.Game.Player.Character.Style.RandomizeProps();
                }
            };
            ...
            outfits.OnItemSelect += async (sender, item, index) =>
            {
                if (item == highway)
                {
                    await CitizenFX.Core.Game.Player.ChangeModel(PedHash.Hwaycop01SMY);
                    CitizenFX.Core.Game.Player.Character.Style.RandomizeOutfit();
                    CitizenFX.Core.Game.Player.Character.Style.RandomizeProps();
                }
            };
